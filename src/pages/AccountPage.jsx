                    ...
                    <div className="w-full lg:w-1/2 p-8">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="mb-6">
                                ...
                                <input type="number" id="salary" {...register("salary", { required: true })} className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" />
                                {errors.salary && <span className="text-red-500">This field is required</span>}
                            </div>
                            <div className="mb-6">
                                <label className="block text-gray-700 mb-2" htmlFor="credit">Credit</label>
                                <input type="number" id="credit" {...register("credit", { required: true })} className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" />
